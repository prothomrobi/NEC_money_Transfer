            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                   ...
                   <li><a href="#">Profile</a>
                    ...
                    <li><a href="find_location.php">Find Location</a>
                    ...
                    <div class="who">
                        ...
                        <div class="col-lg-6 ">
                            <div class="dividerHeading">
                                <h4><span>Welcome to Nec Money Transfer Limited</span></h4>
                            </div>
                            <p>NEC MONEY TRANSFER LIMITED was incorporated in the year 2015 here at United Kingdom. </p>
                            
                            <p>NEC Money Transfer Limited is a Pioneer Money Transfer Company in United Kingdom Which has been Operations In the Money Transfer Business Started since 2015.NEC Money Transfer Limited, United Kingdom With a Paid Capital of 1,00,000( I Lac Pound Sterling) That is 0.1 Million and the Other Authorized Capital 20,000,00(Pound Sterling) that is 2 Million. NEC Money Transfer limited authorized Permission By Financial Conduct Authority( FCA) and Approved License no-649461.and Head Office Address—NEC Money Transfer Limited. Docklands Business Centre, Suite 3h & 3g.10-16 Tiller Road, Canary Wharf, London-E14 8PX. </p>
                            
                        <ul>
                            <li>NEC Money Transfer Limited have got the API license (Company No……) issued by FCA- U.K.</li>
                            <li>NEC Money Transfer partners are authorized financial institutions, Banks & Exchange houses around the world.</li>
                            <li>We have own centralize online web based received and payment system all over the Europe.</li>
                            <li>NEC Money is the fast and reliable service with a lower commission.</li>
                            <li>NEC Money’s employees work hard to make sure that the services meet our client’s expectation.</li>
                        </ul>
                        </div>
                    </div>
                </div>
