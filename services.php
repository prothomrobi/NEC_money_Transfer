...
<!--End nav-->
    ...
    <div class="container">
        <div class="row" style="margin-left: 50px;">
            <div class="col-md-12">
                <h1 style="color: #8ABE42;">Our Service</h1>
            ...
            <div class="col-md-12">
                ...
                <img src="images/gif/Service.gif">
            </div>
            
            </div>
            </div>
            <div class="col-md-10">
                <h3><strong>We will send your earnest money to your relatives, within a minute.</strong></h3><br>
                <p>You can send your earnest money from our more than 600 NEC Money Transfer branches via more than 2000 branches of different bank in Bangladesh. Also our Client Care Centre is open 24/7.</p><br>
                <h3><strong>This Service is Provided All Over The World.</strong></h3>
            </div>
        </div>
    </div>
