    ...
    <section class="wrapper">
         ...
         <div class="col-md-12">
             ...
             <div class="8 asia_box">
                 <h1>MIDDLE EAST</h1>
                 <div class="col-md-12">
                     <button type="button" class="btn  asia_btn" data-toggle="collapse" data-target="#demo">-----<i style="margin-left: 460px;">------</i></button>
                 ...
                 <div class="col-md-12">
                     <button type="button" class="btn btn-suceess asia_btn" data-toggle="collapse" data-target="#demo1">-----<i style="margin-left: 460px;">------</i></button>
                      <div id="demo1" class="collapse out">
                        ...
                        <div class="col-md-12 second_box">
                          <div class="col-md-6">
                            <div class="col-md-12 asia_box3 asia_img">
                                <div class="col-md-3">
                                   <img src="images/clients/demo_bank2.jpg" /><br />
                 ...
                 <div class="col-md-12">
                     <button type="button" class="btn btn-suceess asia_btn" data-toggle="collapse" data-target="#demo2">------<i style="margin-left: 460px;">-------</i></button>
                 ...
                 <div class="col-md-12">
                     <button type="button" class="btn btn-suceess asia_btn" data-toggle="collapse" data-target="#demo4">------<i style="margin-left: 460px;">------</i></button>
