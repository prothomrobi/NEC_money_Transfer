    ...
    <section class="wrapper">
         ...
         <div class="col-md-12">
             ...
             <div class="8 asia_box">
                 <h1>AFRICA</h1>
                 <div class="col-md-12">
                     <button type="button" class="btn  asia_btn" data-toggle="collapse" data-target="#demo">ETHOPIA<i style="margin-left: 460px;">10 corespondent(s)</i></button>
                 ...
                 <div class="col-md-12">
                     <button type="button" class="btn btn-suceess asia_btn" data-toggle="collapse" data-target="#demo1">KENIYA<i style="margin-left: 470px;">10 corespondent(s)</i></button>
                 ...
                 <div class="col-md-12">
                     <button type="button" class="btn btn-suceess asia_btn" data-toggle="collapse" data-target="#demo2">UGANDA<i style="margin-left: 460px;">10 corespondent(s)</i></button>
                 ...
                 <div class="col-md-12">
                     <button type="button" class="btn btn-suceess asia_btn" data-toggle="collapse" data-target="#demo3">MOROCCO<i style="margin-left: 447px;">10 corespondent(s)</i></button>
                 ...
                 <div class="col-md-12">
                     <button type="button" class="btn btn-suceess asia_btn" data-toggle="collapse" data-target="#demo4"> NIGERIA<i style="margin-left: 460px;">10 corespondent(s)</i></button>
                 ...
                 <div class="col-md-12">
                     <button type="button" class="btn btn-suceess asia_btn" data-toggle="collapse" data-target="#demo5"> TANZANIA<i style="margin-left: 460px;">10 corespondent(s)</i></button>
